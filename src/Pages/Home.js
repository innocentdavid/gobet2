        ...
        <div className="flex flex-col items-center mt-[80px] lg:mt-[284px] pb-20 px-3">
            <div className="sm-items-center flex flex-col lg:flex-row gap-5">
                <div style={{ borderTop: 'none' }} className="flex flex-col rounded-b-[10px]">
                    <div style={{ background: "radial-gradient(circle, rgba(255, 232, 113, 1) 0%, rgba(188, 110, 21, 1) 100%)" }} className=" text-[#330707] font-[400] text-[30px] md:text-[44.32px] leading-[77.65px] px-[30px] md:px-[70px] py-3 font-exotc text-center">The Next BNB Draw</div>
